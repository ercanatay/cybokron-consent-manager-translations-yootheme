...
<div class="cybocoma-wrap">
	<div class="cybocoma-header">
		<h1><?php esc_html_e('Cybokron Consent Manager Translations for YOOtheme Pro', 'cybokron-consent-manager-translations-yootheme-main'); ?></h1>
		<p><?php esc_html_e('Locale-aware consent translation management with live preview, health checks, and rollback snapshots.', 'cybokron-consent-manager-translations-yootheme-main'); ?></p>
	</div>
		...
		<form id="cybocoma-settings-form" method="post">
			...
			<div class="cybocoma-top-bar">
				<div class="cybocoma-select-grid">
					<div class="cybocoma-language-select">
						<label for="cybocoma-scope-locale"><?php esc_html_e('Settings Locale Scope:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
					...
					<div class="cybocoma-language-select">
						<label for="cybocoma-language"><?php esc_html_e('Language Preset:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
						...
						<small class="cybocoma-help-text">
							...
							printf(esc_html__('Scope locale: %s', 'cybokron-consent-manager-translations-yootheme-main'), '<strong>' . esc_html($cybocoma_scope_locale) . '</strong>');
							?>
						</small>
					</div>
				</div>
				...
				<div class="cybocoma-toggle">
					<label for="cybocoma-enabled"><?php esc_html_e('Enable Translations:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
			...
			<div id="cybocoma-updater-panel" class="cybocoma-updater-panel">
				<div class="cybocoma-updater-head">
					<h3><?php esc_html_e('WordPress.org Update Status', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
					<div class="cybocoma-toggle">
						<label for="cybocoma-update-channel-enabled"><?php esc_html_e('Enable Periodic Checks:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
						<label class="cybocoma-switch">
				...
				<p class="cybocoma-help-text">
					<?php esc_html_e('This setting is site-wide (not locale scoped). It refreshes WordPress.org update metadata every 12 hours.', 'cybokron-consent-manager-translations-yootheme-main'); ?>
				</p>
				<div class="cybocoma-updater-grid">
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Current Version:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
					...
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Latest Version:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
						<strong id="cybocoma-updater-latest-version"><?php echo esc_html(!empty($cybocoma_updater['latestVersion']) ? $cybocoma_updater['latestVersion'] : __('Unknown', 'cybokron-consent-manager-translations-yootheme-main')); ?></strong>
					</div>
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Last Check:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
						<strong id="cybocoma-updater-last-check"><?php echo esc_html(!empty($cybocoma_updater['lastCheckedAt']) ? $cybocoma_updater['lastCheckedAt'] : __('Never', 'cybokron-consent-manager-translations-yootheme-main')); ?></strong>
					</div>
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Last Status:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
						<strong id="cybocoma-updater-status"><?php echo esc_html($cybocoma_updater_status_label); ?></strong>
					</div>
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Last Install:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
						<strong id="cybocoma-updater-last-install"><?php echo esc_html(!empty($cybocoma_updater['lastInstallAt']) ? $cybocoma_updater['lastInstallAt'] : __('Never', 'cybokron-consent-manager-translations-yootheme-main')); ?></strong>
					</div>
					<div class="cybocoma-updater-item">
						<span class="cybocoma-updater-label"><?php esc_html_e('Last Error:', 'cybokron-consent-manager-translations-yootheme-main'); ?></span>
						<strong id="cybocoma-updater-last-error"><?php echo esc_html(!empty($cybocoma_updater['lastError']) ? $cybocoma_updater['lastError'] : __('None', 'cybokron-consent-manager-translations-yootheme-main')); ?></strong>
					</div>
				</div>
				<div class="cybocoma-updater-actions">
					<button type="button" id="cybocoma-check-update-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Check Now', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
				</div>
			</div>

			<div id="cybocoma-health-panel" class="cybocoma-health cybocoma-health-<?php echo esc_attr($cybocoma_health['status']); ?>">
				<h3><?php esc_html_e('Compatibility Health', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
				<p><?php esc_html_e('Monitors compatibility with YOOtheme consent source strings.', 'cybokron-consent-manager-translations-yootheme-main'); ?></p>
				<ul class="cybocoma-health-list" id="cybocoma-health-list">
					...
					<?php elseif (!empty($cybocoma_health['warnings'])) : ?>
						...
						<?php endforeach; ?>
					<?php else : ?>
						<li class="cybocoma-health-ok"><?php esc_html_e('No compatibility issues reported.', 'cybokron-consent-manager-translations-yootheme-main'); ?></li>
					<?php endif; ?>
				</ul>
			</div>
			...
			<div
				...
				aria-label="<?php esc_attr_e('Translation sections', 'cybokron-consent-manager-translations-yootheme-main'); ?>"
			>
			...
			<div class="cybocoma-search-bar">
				<div class="cybocoma-search-wrapper">
					<input type="text" id="cybocoma-search-strings" class="cybocoma-search-input" placeholder="<?php esc_attr_e('Search translation strings...', 'cybokron-consent-manager-translations-yootheme-main'); ?>">
					<button type="button" id="cybocoma-search-clear" class="cybocoma-search-clear" style="display:none;" aria-label="<?php esc_attr_e('Clear search', 'cybokron-consent-manager-translations-yootheme-main'); ?>">&times;</button>
				</div>
			...
			<div id="cybocoma-no-results" class="cybocoma-no-results" style="display:none;">
				<?php esc_html_e('No matching strings found.', 'cybokron-consent-manager-translations-yootheme-main'); ?>
			</div>
			...
			?>
				...
				>
					<div class="cybocoma-category-header">
						...
						<h3><?php echo esc_html($cybocoma_group['label']); ?> <?php esc_html_e('Strings', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
					</div>
					...
					<?php foreach ($cybocoma_group['keys'] as $cybocoma_key) :
						...
						<div class="cybocoma-string-group" data-key="<?php echo esc_attr($cybocoma_key); ?>">
							...
							<div class="cybocoma-original">
								<strong><?php esc_html_e('Original:', 'cybokron-consent-manager-translations-yootheme-main'); ?></strong><br>
							...
							<?php if ($cybocoma_is_long) : ?>
								<textarea
									...
									placeholder="<?php esc_attr_e('Enter translation...', 'cybokron-consent-manager-translations-yootheme-main'); ?>"
							...
							<div class="cybocoma-field-tools">
								<button type="button" class="cybocoma-btn cybocoma-btn-link cybocoma-reset-field" data-key="<?php echo esc_attr($cybocoma_key); ?>">
									<?php esc_html_e('Reset Field', 'cybokron-consent-manager-translations-yootheme-main'); ?>
								</button>
							...
							<?php if ($cybocoma_has_placeholder) : ?>
								<span class="cybocoma-placeholder-note">
									...
									printf(
										...
										esc_html__('Keep %1$s or %2$s in your translation. It will be replaced with the Privacy Policy URL.', 'cybokron-consent-manager-translations-yootheme-main'),
										'%s',
										'%1$s'
									);
									?>
			...
			<div class="cybocoma-preview-panel" id="cybocoma-preview-panel">
				<h3><?php esc_html_e('Live Preview', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
			...
			<div class="cybocoma-footer">
				<div class="cybocoma-primary-actions">
					<button type="submit" id="cybocoma-save-btn" class="cybocoma-btn cybocoma-btn-primary">
						<?php esc_html_e('Save Changes', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
					<button type="button" id="cybocoma-reset-btn" class="cybocoma-btn cybocoma-btn-danger">
						<?php esc_html_e('Reset to Default', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
				</div>

				<div class="cybocoma-secondary-actions">
					<button type="button" id="cybocoma-quality-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Run QA Check', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
					<button type="button" id="cybocoma-health-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Run Health Check', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
					<button type="button" id="cybocoma-import-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Import', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
					<button type="button" id="cybocoma-export-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Export', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
					<button type="button" id="cybocoma-copy-locale-btn" class="cybocoma-btn cybocoma-btn-secondary">
						<?php esc_html_e('Copy From Locale', 'cybokron-consent-manager-translations-yootheme-main'); ?>
					</button>
				</div>
			</div>

			<div class="cybocoma-snapshot-tools">
				<label for="cybocoma-snapshot-select"><?php esc_html_e('Snapshots:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
				<select id="cybocoma-snapshot-select">
					<option value=""><?php esc_html_e('Select a snapshot', 'cybokron-consent-manager-translations-yootheme-main'); ?></option>
				...
				<button type="button" id="cybocoma-restore-btn" class="cybocoma-btn cybocoma-btn-secondary">
					<?php esc_html_e('Restore Snapshot', 'cybokron-consent-manager-translations-yootheme-main'); ?>
				</button>
			</div>
...
<div id="cybocoma-import-modal" class="cybocoma-modal-overlay">
	<div class="cybocoma-modal">
		<h3><?php esc_html_e('Import Settings', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
		<form id="cybocoma-import-form" enctype="multipart/form-data">
			<div class="cybocoma-file-input-wrapper">
				...
				<p><?php esc_html_e('Click or drag a JSON file here', 'cybokron-consent-manager-translations-yootheme-main'); ?></p>
			...
			<div class="cybocoma-modal-actions">
				<button type="button" class="cybocoma-btn cybocoma-btn-secondary cybocoma-modal-close">
					<?php esc_html_e('Cancel', 'cybokron-consent-manager-translations-yootheme-main'); ?>
				</button>
...
<div id="cybocoma-copy-locale-modal" class="cybocoma-modal-overlay">
	<div class="cybocoma-modal">
		<h3><?php esc_html_e('Copy Settings From Another Locale', 'cybokron-consent-manager-translations-yootheme-main'); ?></h3>
		<p class="cybocoma-help-text"><?php esc_html_e('Select a source locale to copy all translation settings from. This will overwrite the current locale scope settings.', 'cybokron-consent-manager-translations-yootheme-main'); ?></p>
		<form id="cybocoma-copy-locale-form">
			<div class="cybocoma-copy-locale-select">
				<label for="cybocoma-copy-source-locale"><?php esc_html_e('Source Locale:', 'cybokron-consent-manager-translations-yootheme-main'); ?></label>
				<select id="cybocoma-copy-source-locale">
					<option value=""><?php esc_html_e('Select a locale...', 'cybokron-consent-manager-translations-yootheme-main'); ?></option>
					<?php foreach ($cybocoma_scope_locales as $cybocoma_locale_option) : ?>
			...
			<div class="cybocoma-modal-actions">
				...
				<button type="submit" id="cybocoma-copy-locale-submit" class="cybocoma-btn cybocoma-btn-primary">
					<?php esc_html_e('Copy Settings', 'cybokron-consent-manager-translations-yootheme-main'); ?>
				</button>
			</div>
		</form>
	</div>
